/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/8994*@* */
...
void setup()
{
  ...
  for(int y = 0; y < rows; y++) {
    for(int x = 0; x < columns; x++) {
      ...
      boxes[index].springColor = color(random(5),random(5),random(5));
